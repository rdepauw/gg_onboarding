...
export const metadata: Metadata = generatePageMetadata({
  title: "Free Golf Drills, Feels & Games Library — 248+ Practice Resources",
  description: "Browse 248+ golf drills, feels, and practice games. Filter by skill — putting, short game, approach, off the tee. Free access with email.",
  path: "/library",
})
